...
class DefaultValidator(object):
  ...
  def create(self, schema):
    ...
    def iter_errors(validator, instance):
      e = None
      index = len(self.applied_schemas)
      for e in original_iter_errors(validator, instance):
        del self.applied_schemas[index:]
        yield e
      if e is None and validator.schema.get('properties'):
        ...
        self.applied_schemas.append((validator, base_uri, instance))
  ...
  def collect_defaults(self):
    ...
    while index < len(self.applied_schemas):
      validator, base_uri, instance = self.applied_schemas[index]
