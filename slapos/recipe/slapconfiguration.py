...
class JsonSchema(Recipe):
  ...
  Input:
    ...
    set-shared-default
      ...
      Example:
        true
    skip-validation-of-main
      Flag to skip validating main parameters.
      False by default; any value makes this flag behave as true.
      Example:
        true
    skip-validation-of-shared
  ...
  def _expandParameterDict(self, options, parameter_dict):
    ...
    validate_main = 'skip-validation-of-main' not in options
    validate_shared = 'skip-validation-of-shared' not in options
