...
::
  myawesomekvm = request(
      software_release="http://git.erp5.org/gitweb/slapos.git/blob_plain/refs/heads/manual-kvm:/software/manual_kvm/development.cfg",
...
All the scripts generated by SlapOS can be found in ~/etc/scripts.
If you want to start your instance without those, you can access the binaries
through the ~/software_release/parts directory.
