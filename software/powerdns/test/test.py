...
class TestSlaveRequestSingleDomain(TestSlaveRequest):
  ...
  def getSlaveParameterDictDict(cls):
    ...
    for index, zone in enumerate(supported_zone_list):
      for default_slave_name, slave in default_slave_parameter_dict_dict\
        ...
        slave['applicable-zone'] = zone
    return slave_parameter_dict_dict


class TestSlaveRequestDomains(TestSlaveRequestSingleDomain):
