...
SLAPOS_TEST_LONG = bool(int(os.environ.get('SLAPOS_TEST_LONG', 0)))
...
@unittest.skipUnless(SLAPOS_TEST_LONG,
  'Set SLAPOS_TEST_LONG=1 to enable ERP5-in-Theia resilience test')
