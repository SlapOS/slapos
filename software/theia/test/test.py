...
class TestTheiaExportImport(TheiaResilienceMixin, ResilientTheiaTestCase):
  ...
  def _doBackup(self):
    ...
    # Copy <export>/srv/backup to <import>/srv/backup manually
    export_backup_path = self._getTypePartitionPath('export', 'srv', 'backup')
    import_backup_path = self._getTypePartitionPath('import', 'srv', 'backup')
