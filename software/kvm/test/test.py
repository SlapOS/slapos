...
class TestAccessKvmClusterBootstrap(MonitorAccessMixin, KVMTestCase):
  ...
  def test_2machines(self):
    ...
    # a configuration with 2 machines won't work because we can't have 2 VM started in the same partition (because they would use the same tap). We can still test that the parameters for the 2nd machine exist.
