...
class TestAccessDefaultBootstrap(MonitorAccessMixin, InstanceTestCase):
  ...
  @classmethod
  def getInstanceParameterDict(cls):
    return {'_': json.dumps(bootsrtrap_common_param_dict.update(bootstrap_machine_param_dict))}
...
class TestAccessKvmClusterBootstrap(MonitorAccessMixin, InstanceTestCase):
  ...
  @classmethod
  def getInstanceParameterDict(cls):
    return {'_': json.dumps(bootsrtrap_common_param_dict.update({
      "kvm-partition-dict": {
          "test-machine1": bootstrap_machine_param_dict,
          "test-machine2": bootstrap_machine_param_dict.update({
