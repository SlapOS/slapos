...
https://www.google.com {}""",
  ...
  def test_master_partition_state(self):
    ...
    expected_parameter_dict = {
      ...
      '"_server-alias-unsafe": ["server-alias \'${section:option}\' not valid"'
      ',"server-alias \'afterspace\' not valid"], "_custom_domain-unsafe": '
      '["custom_domain \'${section:option} afterspace\\\\nafternewline\' '
      'invalid"], "_ssl_key-ssl_crt-unsafe": ["slave ssl_key and ccl_crt does'
      ' not match"]}'
    }
