...
""",
  ...
  def test_https_only(self):
    ...
    # Note: Redir does not go together with rewrite
    #       but anyway it is going to be normalized later (as seen above)
    self.assertEqual(
      'https://httpsonly.example.com/test-path/deep/.././deeper',
