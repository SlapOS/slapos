...
class HttpFrontendTestCase(SlapOSInstanceTestCase):
  ...
  def assertResponseHeaders(
    self, result, cached=False, via_disabled=False, backend_reached=True):
...
""",
  ...
  def test_url(self):
    ...
    headers = self.assertResponseHeaders(result_http, backend_reached=False)
    self.assertEqual(
...
<note>
  ...
  def test_enable_cache_https_only(self):
    ...
    self.assertResponseHeaders(result, cached=False)
  ...
  def test_enable_cache_disable_via_header(self):
    ...
    headers = self.assertResponseHeaders(result, via_disabled=False)
