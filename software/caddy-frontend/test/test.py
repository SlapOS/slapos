...
'''
  ...
  def test_monitor_setup(self):
    ...
    self.monitor_configuration_list = [
      {
        'htmlUrl': 'https://[%s]:13000/public/feed' % (IP,),
        'text': 'testing partition 0',
        'title': 'testing partition 0',
        'type': 'rss',
        'url': 'https://[%s]:13000/share/private/' % (IP,),
        'version': 'RSS',
        'xmlUrl': 'https://[%s]:13000/public/feed' % (IP,),
      },
      {
        'htmlUrl': 'https://[%s]:13001/public/feed' % (IP,),
        'text': 'caddy-frontend-1',
        'title': 'caddy-frontend-1',
        'type': 'rss',
        'url': 'https://[%s]:13001/share/private/' % (IP,),
        'version': 'RSS',
        'xmlUrl': 'https://[%s]:13001/public/feed' % (IP,),
      },
      {
        'htmlUrl': 'https://[%s]:8196/public/feed' % (IP,),
        'text': 'kedifa',
        'title': 'kedifa',
        'type': 'rss',
        'url': 'https://[%s]:8196/share/private/' % (IP,),
        'version': 'RSS',
        'xmlUrl': 'https://[%s]:8196/public/feed' % (IP,),
      }
    ]
