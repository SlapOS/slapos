...
class JSDroneTestCase(SlapOSInstanceTestCase):
  ...
  def test_pubsub_subscription(self):
    ...
    for line in (
      ...
      'Received latitude of drone 0: %f°' % POSITION_ARRAY_VALUES[0],
      'Received longitude of drone 0: %f°' % POSITION_ARRAY_VALUES[1],
      'Received absolute altitude of drone 0: %fm' % POSITION_ARRAY_VALUES[2],
      'Received relative altitude of drone 0: %fm' % POSITION_ARRAY_VALUES[3],
      'Received yaw of drone 0: %f°' % SPEED_ARRAY_VALUES[0],
      'Received speed of drone 0: %fm/s' % SPEED_ARRAY_VALUES[1],
      'Received climb rate of drone 0: %fm/s' % SPEED_ARRAY_VALUES[2],
      'Received message of drone 0: %s' % TEST_MESSAGE.decode(),
    ):
