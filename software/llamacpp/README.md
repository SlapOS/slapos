...
For the parameters that running the llama.cpp, you can check instance-input-schema.json to see the provided options. You can check [llama-server's docs](https://github.com/ggml-org/llama.cpp/blob/master/tools/server/README.md) to understand it better.
