...
======  ==========================  ============================================  ====================
Code    Reason                      When it appears                                Who can customise
======  ==========================  ============================================  ====================
400     Bad Request                 Malformed HTTP request received by the CDN     Operator
404     Not Found                   Request for an address not served by this CDN  Operator
408     Request Timeout             Client did not send a complete request in time Operator
500     Internal Server Error       Unexpected error inside the CDN                Operator
502     Bad Gateway                 Backend returned an invalid response           Operator + Site owner
503     Service Unavailable         No healthy backend available                   Operator + Site owner
504     Gateway Timeout             Backend did not respond in time                Operator + Site owner
======  ==========================  ============================================  ====================

Codes 400, 404, 408, and 500 are CDN-internal errors and only meaningful
at the operator level.


Web management interface (operator only)
----------------------------------------
...
Site owners do not have a web UI; they use the REST API below.
