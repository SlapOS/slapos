...
own backend errors (see ``error-pages-slave.rst``).
...
Codes 400, 408, and 500 are CDN-internal errors.  Sites owners cannot
...
The software release ships default pages for all six supported codes.
