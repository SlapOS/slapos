...
(function (document, RSVP, XMLHttpRequest) {
  ...
  var promise_list = [],
    ...
    test_url_list = [
      ...
      { name : 'China-A',
        testurl: "http://demoapp9.erp5.cn/WebSite_getTestFrontendResponse",
        redirect: "http://demoapp9.erp5.cn" + relative_url_path },
      { name : 'China-Q',
        testurl: "http://demoapp0.erp5.cn/WebSite_getTestFrontendResponse",
        redirect: "http://demoapp0.erp5.cn" + relative_url_path },
      { name : 'China-U',
        testurl: "http://demoapp1.erp5.cn/WebSite_getTestFrontendResponse",
        redirect: "http://demoapp1.erp5.cn" + relative_url_path },
      { name : 'France-O',
